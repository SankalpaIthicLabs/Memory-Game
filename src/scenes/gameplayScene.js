...
export class GamePlayScene extends Phaser.Scene {
  ...
  imageLoader() {
    this.load.image('character1', this.assetPathUrl+'/assets/images/1.png');
    this.load.image('character2', this.assetPathUrl+'/assets/images/2.png');
    this.load.image('character3', this.assetPathUrl+'/assets/images/3.png');
    this.load.image('character4', this.assetPathUrl+'/assets/images/4.png');
    this.load.image('character5', this.assetPathUrl+'/assets/images/5.png');
    this.load.image('character6', this.assetPathUrl+'/assets/images/6.png');
